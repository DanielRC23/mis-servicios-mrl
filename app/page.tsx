      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <Card className="w-full max-w-2xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>Para usar la aplicación, necesitas configurar Supabase</CardDescription>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="text-center">
            <CardHeader>
              ...
              <CardTitle className="text-lg">Servicios Cercanos</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>Encuentra profesionales verificados en tu zona de Morelia</CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardTitle className="text-lg">Verificados</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
          ...
          <Card className="text-center">
            ...
            <CardContent>
              <CardDescription>Sistema de reseñas y calificaciones de clientes reales</CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            ...
            <CardContent>
              <CardDescription>Únete a la comunidad de servicios más grande de Morelia</CardDescription>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h3 className="text-3xl font-bold text-center mb-12">Categorías de Servicios</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <CardTitle className="text-lg">Servicios Personales</CardTitle>
              </CardHeader>
              <CardContent>
