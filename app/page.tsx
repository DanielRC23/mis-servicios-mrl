      ...
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex flex-col items-center space-y-4 md:hidden">
            ...
            {user && firstName && (
              <div className="text-center">
                <p className="text-lg font-semibold text-blue-600">¡Hola, {firstName}!</p>
              </div>
            )}
            {!user && (
          ...
          <div className="hidden md:flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-gray-900">Mis Servicios Mrl</h1>
              {user && firstName && <p className="text-lg font-semibold text-blue-600 ml-4">¡Hola, {firstName}!</p>}
            </div>
            {!user && (
              <div className="flex space-x-2">
                <Link href="/login">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="hover:shadow-lg transition-shadow bg-white">
              <CardHeader>
                <CardTitle className="text-lg text-gray-900">🏠 Servicios del Hogar</CardTitle>
              </CardHeader>
              <CardContent>
